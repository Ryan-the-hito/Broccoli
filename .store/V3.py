...
import typings as t
from utilsA import create_completer
from utilsA import create_keybindings
from utilsA import create_session
from utilsA import get_filtered_keys_from_object
from utilsA import get_input
...
class Chatbot:
    ...
    def get_token_count(self, convo_id: str = "default") -> int:
        ...
        encoding = GPT2Tokenizer.from_pretrained('EleutherAI/gpt-neo-2.7B')
